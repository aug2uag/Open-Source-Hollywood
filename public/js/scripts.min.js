...
!function(t){"use strict";var s=function(s,e){this.el=t(s),this.options=t.extend({},t.fn.typed.defaults,e),this.isInput=this.el.is("input"),this.attr=this.options.attr,this.showCursor=this.isInput?!1:this.options.showCursor,this.elContent=this.attr?this.el.attr(this.attr):this.el.text(),this.contentType=this.options.contentType,this.typeSpeed=this.options.typeSpeed,this.startDelay=this.options.startDelay,this.backSpeed=this.options.backSpeed,this.backDelay=this.options.backDelay,this.strings=this.options.strings,this.strPos=0,this.arrayPos=0,this.stopNum=0,this.loop=this.options.loop,this.loopCount=this.options.loopCount,this.curLoop=0,this.stop=!1,this.cursorChar=this.options.cursorChar,this.shuffle=this.options.shuffle,this.sequence=[],this.build()};s.prototype={constructor:s,init:function(){var t=this;t.timeout=setTimeout(function(){for(var s=0;s<t.strings.length;++s)t.sequence[s]=s;t.shuffle&&(t.sequence=t.shuffleArray(t.sequence)),t.typewrite(t.strings[t.sequence[t.arrayPos]],t.strPos)},t.startDelay)},build:function(){this.showCursor===!0&&(this.cursor=t('<span class="typed-cursor">'+this.cursorChar+"</span>"),this.el.after(this.cursor)),this.init()},typewrite:function(t,s){if(this.stop!==!0){var e=Math.round(70*Math.random())+this.typeSpeed,o=this;o.timeout=setTimeout(function(){var e=0,r=t.substr(s);if("^"===r.charAt(0)){var i=1;/^\^\d+/.test(r)&&(r=/\d+/.exec(r)[0],i+=r.length,e=parseInt(r)),t=t.substring(0,s)+t.substring(s+i)}if("html"===o.contentType){var n=t.substr(s).charAt(0);if("<"===n||"&"===n){var a="",h="";for(h="<"===n?">":";";t.substr(s).charAt(0)!==h;)a+=t.substr(s).charAt(0),s++;s++,a+=h}}o.timeout=setTimeout(function(){if(s===t.length){if(o.options.onStringTyped(o.arrayPos),o.arrayPos===o.strings.length-1&&(o.options.callback(),o.curLoop++,o.loop===!1||o.curLoop===o.loopCount))return;o.timeout=setTimeout(function(){o.backspace(t,s)},o.backDelay)}else{0===s&&o.options.preStringTyped(o.arrayPos);var e=t.substr(0,s+1);o.attr?o.el.attr(o.attr,e):o.isInput?o.el.val(e):"html"===o.contentType?o.el.html(e):o.el.text(e),s++,o.typewrite(t,s)}},e)},e)}},backspace:function(t,s){if(this.stop!==!0){var e=Math.round(70*Math.random())+this.backSpeed,o=this;o.timeout=setTimeout(function(){if("html"===o.contentType&&">"===t.substr(s).charAt(0)){for(var e="";"<"!==t.substr(s).charAt(0);)e-=t.substr(s).charAt(0),s--;s--,e+="<"}var r=t.substr(0,s);o.attr?o.el.attr(o.attr,r):o.isInput?o.el.val(r):"html"===o.contentType?o.el.html(r):o.el.text(r),s>o.stopNum?(s--,o.backspace(t,s)):s<=o.stopNum&&(o.arrayPos++,o.arrayPos===o.strings.length?(o.arrayPos=0,o.shuffle&&(o.sequence=o.shuffleArray(o.sequence)),o.init()):o.typewrite(o.strings[o.sequence[o.arrayPos]],s))},e)}},shuffleArray:function(t){var s,e,o=t.length;if(o)for(;--o;)e=Math.floor(Math.random()*(o+1)),s=t[e],t[e]=t[o],t[o]=s;return t},reset:function(){var t=this;clearInterval(t.timeout);var s=this.el.attr("id");this.el.after('<span id="'+s+'"/>'),this.el.remove(),"undefined"!=typeof this.cursor&&this.cursor.remove(),t.options.resetCallback()}},t.fn.typed=function(e){
    var wwaass = this 
    return this.each(function(_i_d_x_){
        if (_i_d_x_ === wwaass.length) console.log("WOO")
        var o=t(this),r=o.data("typed"),i="object"==typeof e&&e;r||o.data("typed",r=new s(this,i)),"string"==typeof e&&r[e]()})},t.fn.typed.defaults={strings:["These are the default values...","You know what you should do?","Use your own!","Have a great day!"],typeSpeed:0,startDelay:0,backSpeed:0,shuffle:!1,backDelay:500,loop:!1,loopCount:!1,showCursor:!0,cursorChar:"|",attr:null,contentType:"html",callback:function(){},preStringTyped:function(){},onStringTyped:function(){},resetCallback:function(){}}}(window.jQuery);
!function($) {
    var e = !0;
    $.flexslider = function(t, a) {
        ...
        $.data(t, "flexslider", n), f = {
                ...
                function a(e) {
                    ...
                    if (a) {
                        var n = -e.translationX,
                            i = -e.translationY;
                        if (T += d ? i : n, m = (a.vars.rtl ? -1 : 1) * T, x = d ? Math.abs(T) < Math.abs(-n) : Math.abs(T) < Math.abs(-i), e.detail === e.MSGESTURE_FLAG_INERTIA) return void setImmediate(function() {
                            t._gesture.stop()
                        });
                        (!x || Number(new Date) - f > 500) && (e.preventDefault(), !p && a.transitions && (a.vars.animationLoop || (m = T / (0 === a.currentSlide && T < 0 || a.currentSlide === a.last && T > 0 ? Math.abs(T) / c + 2 : 1)), a.setProps(l + m, "setTouch")))
                    }
                }
            ...
            n.transitions && (i = d ? "translate3d(0," + i + ",0)" : "translate3d(" + (n.vars.rtl ? -1 : 1) * parseInt(i) + "px,0,0)", a = void 0 !== a ? a / 1e3 + "s" : "0s", n.container.css("-" + n.pfx + "-transition-duration", a), n.container.css("transition-duration", a)), n.args[n.prop] = i, (n.transitions || void 0 === a) && n.container.css(n.args), n.container.css("transform", i)
        }, n.setup = function(e) {
            if (p) n.vars.rtl ? n.slides.css({
                ...
                "init" === e && (n.viewport = $('<div class="' + i + 'viewport"></div>').css({
                    ...
                    n.doMath(), n.vars.rtl, n.newSlides.css({
                        width: n.computedW,
...
(function(t) {
    ...
    function i(t) {
        if (t) {
            ...
            return t.bridget = function(e, o) {
                var r, s, a;
                (a = o).prototype.option || (a.prototype.option = function(e) {
                    t.isPlainObject(e) && (this.options = t.extend(!0, this.options, e))
                }), r = e, s = o, t.fn[r] = function(e) {
                    if ("string" == typeof e) {
                        for (var o = n.call(arguments, 1), a = 0, h = this.length; h > a; a++) {
                            var c = this[a],
                                l = t.data(c, r);
                            if (l)
                                if (t.isFunction(l[e]) && "_" !== e.charAt(0)) {
                                    var d = l[e].apply(l, o);
        ...
        return function() {
            ...
            function(t) {
                if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    for (var c = h.isBorderBox = !(!a || !n[a] || "border-box" !== n[a]), l = 0, d = r.length; d > l; l++) {
                        var u = r[l],
                            p = n[u];
                        p = i(t, p);
                        var f = parseFloat(p);
                    ...
                    var m = h.paddingLeft + h.paddingRight,
                        ...
                        x = c && s,
                        L = e(n.width);
                    !1 !== L && (h.width = L + (x ? 0 : m + w));
                    var I = e(n.height);
                    return !1 !== I && (h.height = I + (x ? 0 : g + b)), h.innerWidth = h.width - (m + w), h.innerHeight = h.height - (g + b), h.outerWidth = h.width + v, h.outerHeight = h.height + y, h
                }
            }
    }
...
function(t) {
    function e(t, e, i) {
        ...
        var r = i("transition"),
            ...
            d = function() {
                for (var t = {}, e = 0, n = l.length; n > e; e++) {
                    var o = l[e],
                        r = i(o);
                    r && r !== o && (t[o] = r)
                }
        ...
        o.prototype._transitionTo = function(t, e) {
            ...
            if (this.setPosition(t, e), !s || this.isTransitioning) {
                ...
                a = l.isOriginLeft ? a : -a, h = l.isOriginTop ? h : -h, c.transform = u(a, h), this.transition({
                    to: c,
                    onTransitionEnd: {
...
function(t) {
    ...
    function i(t) {
        ...
        if (e = t, "[object Array]" === c.call(e)) i = t;
            ...
            for (var n = 0, o = t.length; o > n; n++) i.push(t[n]);
        else i.push(t);
        return i
    }
    ...
    function o(o, c, d, u, p, f) {
        function m(t, i) {
            if ("string" == typeof t && (t = r.querySelector(t)), t && l(t)) {
        ...
        return m.namespace = "outlayer", m.Item = f, m.defaults = {
            ...
            for (var e = this.options.itemSelector, n = [], o = 0, r = t.length; r > o; o++) {
                ...
                if (l(s))
                    if (e) {
                        p(s, e) && n.push(s);
                        for (var a = s.querySelectorAll(e), h = 0, c = a.length; c > h; h++) n.push(a[h])
                    } else n.push(s)
            }
            return n
            ...
            n ? ("string" == typeof n ? i = this.element.querySelector(n) : l(n) && (i = n), this[t] = i ? u(i)[e] : n) : this[t] = 0
            ...
            return Object.create ? n.prototype = Object.create(m.prototype) : e(n.prototype, m.prototype), n.prototype.constructor = n, n.defaults = e({}, m.defaults), e(n.defaults, i), n.prototype.settings = {}, n.namespace = t, n.data = m.data, n.Item = function() {
                ...
                for (var e = t.replace(/(.)([A-Z])/g, function(t, e, i) {
                        return e + "-" + i
                    }).toLowerCase(), i = r.querySelectorAll(".js-" + e), o = "data-" + e + "-options", h = 0, c = i.length; c > h; h++) {
                    var l, d = i[h],
                        u = d.getAttribute(o);
                    try {
                        l = u && JSON.parse(u)
    ...
    function e(t, e) {
        ...
        return n.prototype._resetLayout = function() {
            ...
            for (var o = this._getColGroup(n), r = Math.min.apply(Math, o), s = i(o, r), a = {
                    ...
                    y: r
                }, h = r + t.size.outerHeight, c = this.cols + 1 - o.length, l = 0; c > l; l++) this.colYs[s + l] = h;
            return a
            ...
            for (var h = (this.options.isOriginTop ? n.top : n.bottom) + i.outerHeight, c = s; a >= c; c++) this.colYs[c] = Math.max(h, this.colYs[c])
...
function(t) {
    function e(t) {
        var e, i = [];
        if (e = t, "[object Array]" === s.call(e)) i = t;
        else if (t && "number" == typeof t.length)
            for (var n = 0, o = t.length; o > n; n++) i.push(t[n]);
        else i.push(t);
        return i
    ...
    function i(t, i, s, h, c) {
        var l = t.create("isotope", {
            layoutMode: "masonry",
            isJQueryFiltering: !0,
            sortAscending: !0
        });
        l.Item = h, l.LayoutMode = c, l.prototype._create = function() {
            ...
            i = i || "*";
            for (var n = [], o = [], r = [], s = this._getFilterTest(i), a = 0, h = t.length; h > a; a++) {
                var c = t[a];
                if (!c.isIgnored) {
                    var l = s(c);
                    l && n.push(c), l && c.isHidden ? o.push(c) : l || c.isHidden || r.push(c)
                }
            }
            var d = this;
        ...
        var d = function() {
            return function(t) {
                ...
                var e, i, n = o(t).split(" "),
                    ...
                    a = s.match(/^\[(.+)\]$/),
                    h = a && a[1],
                    c = (i = s, (e = h) ? function(t) {
                        return t.getAttribute(e)
                    } : function(t) {
                        var e = t.querySelector(i);
                        return e && r(e)
                    }),
                    d = l.sortDataParsers[n[1]];
                return d ? function(t) {
                    return t && d(c(t))
                } : function(t) {
                    return t && c(t)
        ...
        l.sortDataParsers = {
            ...
            if (i) {
                var n = [].concat.apply(i, this.sortHistory),
                    o = (t = n, e = this.options.sortAscending, function(i, n) {
                        for (var o = 0, r = t.length; r > o; o++) {
                            ...
                            if (a > h || h > a) {
                                ...
                                return (a > h ? 1 : -1) * (c ? 1 : -1)
                            }
                        }
                        return 0
                    });
                this.filteredItems.sort(o), i !== this.sortHistory[0] && this.sortHistory.unshift(i)
            }
        ...
        var u = l.prototype.remove;
        return l.prototype.remove = function(t) {
            t = e(t);
            var i, n, o, r = this.getItems(t);
            if (u.call(this, t), r && r.length)
                for (var s = 0, h = r.length; h > s; s++) {
                    var c = r[s];
                    i = c, n = this.filteredItems, void 0, -1 !== (o = a(n, i)) && n.splice(o, 1)
                }
    ...
    i.extend(a, {
        ...
        open: function(t, e) {
            if (t && (i.isPlainObject(e) || (e = {}), !1 !== a.close(!0))) return i.isArray(t) || (t = d(t) ? i(t).get() : [t]), i.each(t, function(o, r) {
                var s, h, c, l, p, f = {};
                "object" === i.type(r) && (r.nodeType && (r = i(r)), d(r) ? (f = {
                    href: r.data("fancybox-href") || r.attr("href"),
                    title: r.data("fancybox-title") || r.attr("title"),
                    isDom: !0,
                    element: r
                }, i.metadata && i.extend(!0, f, r.metadata())) : f = r), s = e.href || f.href || (u(r) ? r : null), h = e.title !== n ? e.title : f.title || "", !(l = (c = e.content || f.content) ? "html" : e.type || f.type) && f.isDom && ((l = r.data("fancybox-type")) || (l = (l = r.prop("class").match(/fancybox\.(\w+)/)) ? l[1] : null)), u(s) && (l || (a.isImage(s) ? l = "image" : a.isSWF(s) ? l = "swf" : "#" === s.charAt(0) ? l = "inline" : u(r) && (l = "html", c = r)), "ajax" === l && (s = (p = s.split(/\s+/, 2)).shift(), p = p.shift())), c || ("inline" === l ? s ? c = i(u(s) ? s.replace(/.*(?=#[^\s]+$)/, "") : s) : f.isDom && (c = r) : "html" === l ? c = s : !l && !s && f.isDom && (l = "inline", c = r)), i.extend(f, {
                    href: s,
                    type: l,
                    content: c,
                    title: h,
        ...
        toggle: function(t) {
            a.isOpen && (a.current.fitToView = "boolean" === i.type(t) ? t : !a.current.fitToView, l && (a.wrap.removeAttr("style").addClass("fancybox-tmp"), a.trigger("onUpdate")), a.update())
        },
        ...
        getViewport: function() {
            ...
            return e ? (i.w = e[0].clientWidth, i.h = e[0].clientHeight) : (i.w = l && t.innerWidth ? t.innerWidth : r.width(), i.h = l && t.innerHeight ? t.innerHeight : r.height()), i
        },
        ...
        bindEvents: function() {
            var t, e = a.current;
            e && (r.bind("orientationchange.fb" + (l ? "" : " resize.fb") + (e.autoCenter && !e.locked ? " scroll.fb" : ""), a.update), (t = e.keys) && s.bind("keydown.fb", function(o) {
        ...
        _start: function(t) {
            ...
            if (e = (o = i.extend(!0, {}, a.opts, e)).margin, n = o.padding, "number" === i.type(e) && (o.margin = [e, e, e, e]), "number" === i.type(n) && (o.padding = [n, n, n, n]), o.modal && i.extend(!0, o, {
                    closeBtn: !1,
                    closeClick: !1,
                    nextClick: !1,
                    arrows: !1,
                ...
                if (a.isActive = !0, "image" !== n && "swf" !== n || (o.autoHeight = o.autoWidth = !1, o.scrolling = "visible"), "image" === n && (o.aspectRatio = !0), "iframe" === n && l && (o.scrolling = "scroll"), o.wrap = i(o.tpl.wrap).addClass("fancybox-" + (l ? "mobile" : "desktop") + " fancybox-type-" + n + " fancybox-tmp " + o.wrapCSS).appendTo(o.parent || "body"), i.extend(o, {
        ...
        _loadIframe: function() {
            var t = a.coming,
                e = i(t.tpl.iframe.replace(/\{rnd\}/g, (new Date).getTime())).attr("scrolling", l ? "auto" : t.iframe.scrolling).attr("src", t.href);
            i(t.wrap).bind("onReset", function() {
                try {
                    i(this).find("iframe").hide().attr("src", "//about:blank").end().empty()
                } catch (t) {}
            }), t.iframe.preload && (a.showLoading(), e.one("load", function() {
                i(this).data("ready", 1), l || i(this).bind("load.fb", a.update), i(this).parents(".fancybox-wrap").width("100%").removeClass("fancybox-tmp").show(), a._afterLoad()
        ...
        _setDimension: function() {
            var t, e, n, o, r, s, h, c, l, d = a.getViewport(),
                u = 0,
                g = !1,
                v = !1,
                y = (g = a.wrap, a.skin),
                ...
                S = f(k[1] + k[3]),
                O = f(k[0] + k[2]);
            if (g.add(y).add(w).width("auto").height("auto").removeClass("fancybox-tmp"), e = S + (k = f(y.outerWidth(!0) - y.width())), n = O + (t = f(y.outerHeight(!0) - y.height())), o = p(v) ? (d.w - e) * f(v) / 100 : v, r = p(x) ? (d.h - n) * f(x) / 100 : x, "iframe" === b.type) {
                if (l = b.content, b.autoHeight && 1 === l.data("ready")) try {
                    l[0].contentWindow.document.location && (w.width(o).height(9999), s = l.contents().find("body"), T && s.css("overflow-x", "hidden"), r = s.outerHeight(!0))
                } catch (t) {}
            ...
            if (v = f(o), x = f(r), c = o / r, L = f(p(L) ? f(L, "w") - e : L), E = f(p(E) ? f(E, "w") - e : E), I = f(p(I) ? f(I, "h") - n : I), s = E, h = _ = f(p(_) ? f(_, "h") - n : _), b.fitToView && (E = Math.min(d.w - e, E), _ = Math.min(d.h - n, _)), e = d.w - S, O = d.h - O, b.aspectRatio ? (v > E && (x = f((v = E) / c)), x > _ && (v = f((x = _) * c)), v < L && (x = f((v = L) / c)), x < I && (v = f((x = I) * c))) : (v = Math.max(L, Math.min(v, E)), b.autoHeight && "iframe" !== b.type && (w.width(v), x = w.height()), x = Math.max(I, Math.min(x, _))), b.fitToView)
                if (w.width(v).height(x), g.width(v + k), d = g.width(), S = g.height(), b.aspectRatio)
                    for (;
                        (d > e || S > O) && v > L && x > I && !(19 < u++);) x = Math.max(I, Math.min(_, x - 10)), v = f(x * c), v < L && (v = L, x = f(v / c)), v > E && (v = E, x = f(v / c)), w.width(v).height(x), g.width(v + k), d = g.width(), S = g.height();
                else v = Math.max(L, Math.min(v, v - (d - e))), x = Math.max(I, Math.min(x, x - (S - O)));
            T && "auto" === C && x < r && v + k + T < e && (v += T), w.width(v).height(x), g.width(v + k), d = g.width(), S = g.height(), g = (d > e || S > O) && v > L && x > I, v = b.aspectRatio ? v < s && x < h && v < o && x < r : (v < s || x < h) && (v < o || x < r), i.extend(b, {
                dim: {
                    width: m(d),
                    height: m(S)
                },
                ...
                wPadding: k,
                hPadding: t,
                wrapSpace: S - y.outerHeight(!0),
                skinSpace: y.height() - x
            }), !l && b.autoHeight && x > I && x < _ && !v && w.height("auto")
        },
        ...
        getOrigPosition: function() {
            var t = a.current,
                ...
                h = t.wPadding,
                c = a.getViewport();
            return !i && t.isDom && e.is(":visible") && ((i = e.find("img:first")).length || (i = e)), d(i) ? (n = i.offset(), i.is("img") && (o = i.outerWidth(), r = i.outerHeight())) : (n.top = c.y + (c.h - r) * t.topRatio, n.left = c.x + (c.w - o) * t.leftRatio), ("fixed" === a.wrap.css("position") || t.locked) && (n.top -= c.y, n.left -= c.x), {
        ...
        step: function(t, e) {
            var i, n, o = e.prop,
                ...
                s = n.skinSpace;
            "width" !== o && "height" !== o || (i = e.end === e.start ? 1 : (t - e.start) / (e.end - e.start), a.isClosing && (i = 1 - i), n = t - (n = "width" === o ? n.wPadding : n.hPadding), a.skin[o](f("width" === o ? n : n - r * i)), a.inner[o](f("width" === o ? n : n - r * i - s * i)))
        },
        zoomIn: function() {
            var t = a.current,
                e = t.pos,
        ...
        changeIn: function() {
            var t, e = a.current,
                ...
                r = a.direction;
            n.opacity = .1, "elastic" === i && (t = "down" === r || "up" === r ? "top" : "left", "down" === r || "right" === r ? (n[t] = m(f(n[t]) - 200), o[t] = "+=200px") : (n[t] = m(f(n[t]) + 200), o[t] = "-=200px")), "none" === i ? a._afterZoomIn() : a.wrap.css(n).animate(o, {
            ...
            if (i.isFunction(n) && (n = n.call(e.element, e)), u(n) && "" !== i.trim(n)) {
                switch (e = i('<div class="fancybox-title fancybox-title-' + o + '-wrap">' + n + "</div>"), o) {
                    ...
                    case "over":
                        ...
                        break;
                    default:
                        o = a.skin, e.appendTo("body"), h && e.width(e.width()), e.wrapInner('<span class="child"></span>'), a.current.margin[2] += Math.abs(f(e.css("margin-bottom")))
                }
        ...
        var e, n = i(this),
            o = this.selector || "",
            r = function(r) {
                var s, h, c = i(this).blur(),
                    l = e;
                !r.ctrlKey && !r.altKey && !r.shiftKey && !r.metaKey && !c.is(".fancybox-wrap") && (s = t.groupAttr || "data-fancybox-group", (h = c.attr(s)) || (s = "rel", h = c.get(0)[s]), h && "" !== h && "nofollow" !== h && (l = (c = (c = o.length ? i(o) : n).filter("[" + s + '="' + h + '"]')).index(this)), t.index = l, !1 !== a.open(c, t) && r.preventDefault())
            };
        return e = (t = t || {}).index || 0, o && !1 !== t.live ? s.undelegate(o, "click.fb-start").delegate(o + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", r) : n.unbind("click.fb-start").bind("click.fb-start", r), this.filter("[data-fancybox-start=1]").trigger("click"), this
    }, s.ready(function() {
        var e, r;
...
function(t) {
    var e, i, n, o = !1,
        ...
        c = 0,
        l = function() {
            o && (requestAnimFrame(l), -.1 > c || .1 < c) && (0 < (r += c) ? r = c = 0 : r < i && (c = 0, r = i), e.scrollTop(-r), c *= .95, h && h())
        },
        d = function(t) {
            t.preventDefault();
            var i = 0 > (t = (t = t.originalEvent).detail ? -1 * t.detail : t.wheelDelta / 40) ? -1 : 1;
            i != n && (c = 0, n = i), r = -e.scrollTop(), c += 1 * ((s += t) - a), a = s
        };
    window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
        window.setTimeout(t, 1e3 / 60)
    }, t.fn.smoothWheel = function(n) {
        var c = jQuery.extend({}, n);
        return this.each(function(n, u) {
            "ontouchstart" in window || ((e = t(this)).bind("mousewheel", d), e.bind("DOMMouseScroll", d), s = a = e.get(0).scrollTop, r = -s, i = e.get(0).clientHeight - e.get(0).scrollHeight, c.onRender && (h = c.onRender), c.remove ? (log("122", "smoothWheel", "remove", ""), o = !1, e.unbind("mousewheel", d), e.unbind("DOMMouseScroll", d)) : o || (o = !0, l()))
        })
    }
}(jQuery),
function() {
...
function(t, e) {
    ...
    r.prototype = new e, r.prototype.options = {}, r.prototype.getImages = function() {
        ...
        function t(t, o) {
            return e.options.debug && l && c.log("confirm", t, o), e.progress(t), ++i === n && e.complete(), !0
        }
        var e = this,
            i = 0,
        ...
        return new r(this, t, e).jqDeferred.promise(h(this))
...
function(t, e, i, n) {
    ...
    function l(t, e) {
        return typeof t == tt ? t.apply(e && e[0] || n, e) : t
    }
    ...
    function b(t, e) {
        for (var i, o, r = e[0].toUpperCase() + e.slice(1), s = 0; s < J.length;) {
            if ((o = (i = J[s]) ? i + r : e) in t) return o;
            s++
        }
        return n
    }
    ...
    function I(t, e, i) {
        ...
        i.isFirst = !!s, i.isFinal = !!a, s && (t.session = {}), i.eventType = e,
            function(t, e) {
                ...
                var s = i.firstInput,
                    a = i.firstMultiple,
                    h = a ? a.center : s.center,
                    c = e.center = _(o);
                e.timeStamp = nt(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = S(h, c), e.distance = k(h, c), l = i, d = e, u = d.center, p = l.offsetDelta || {}, m = l.prevDelta || {}, g = l.prevInput || {}, d.eventType !== pt && g.eventType !== mt || (m = l.prevDelta = {
                    x: g.deltaX || 0,
                    y: g.deltaY || 0
                }, p = l.offsetDelta = {
                    x: u.x,
                    y: u.y
                }), d.deltaX = m.x + (u.x - p.x), d.deltaY = m.y + (u.y - p.y), e.offsetDirection = T(e.deltaX, e.deltaY);
                var l, d, u, p, m, g;
                var v = C(e.deltaTime, e.deltaX, e.deltaY);
                e.overallVelocityX = v.x, e.overallVelocityY = v.y, e.overallVelocity = it(v.x) > it(v.y) ? v.x : v.y, e.scale = a ? (b = a.pointers, x = o, k(x[0], x[1], Ct) / k(b[0], b[1], Ct)) : 1, e.rotation = a ? (y = a.pointers, w = o, S(w[1], w[0], Ct) + S(y[1], y[0], Ct)) : 0, e.maxPointers = i.prevInput ? e.pointers.length > i.prevInput.maxPointers ? e.pointers.length : i.prevInput.maxPointers : e.pointers.length,
                    function(t, e) {
                        var i, o, r, s, a = t.lastInterval || e,
                            h = e.timeStamp - a.timeStamp;
                        if (e.eventType != gt && (h > ut || a.velocity === n)) {
                            var c = e.deltaX - a.deltaX,
                                l = e.deltaY - a.deltaY,
                                d = C(h, c, l);
                            o = d.x, r = d.y, i = it(d.x) > it(d.y) ? d.x : d.y, s = T(c, l), t.lastInterval = e
    ...
    function T(t, e) {
        return t === e ? vt : it(t) >= it(e) ? 0 > t ? yt : wt : 0 > e ? bt : xt
    }
    ...
    function O() {
        this.evEl = kt, this.evWin = St, this.pressed = !1, L.apply(this, arguments)
    }

    function M() {
        this.evEl = zt, this.evWin = jt, L.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
    }

    function z() {
        this.evTarget = Rt, this.evWin = Pt, this.started = !1, L.apply(this, arguments)
    }

    function j() {
        this.evTarget = Dt, this.targetIds = {}, L.apply(this, arguments)
    }

    function A() {
        L.apply(this, arguments);
        var t = c(this.handler, this);
        this.touch = new j(this.manager, t), this.mouse = new O(this.manager, t), this.primaryTouch = null, this.lastTouches = []
    }
    ...
    function W(t) {
        this.options = K({}, this.defaults, t || {}), this.id = st++, this.manager = null, this.options.enable = d(this.options.enable, !0), this.state = Zt, this.simultaneous = {}, this.requireFail = []
    }

    function D(t) {
        return t & ee ? "cancel" : t & $t ? "end" : t & Jt ? "move" : t & Kt ? "start" : ""
    }

    function q(t) {
        return t == xt ? "down" : t == bt ? "up" : t == yt ? "left" : t == wt ? "right" : ""
    }
    ...
    function U(t, e) {
        return (e = e || {}).recognizers = d(e.recognizers, U.defaults.preset), new G(t, e)
    }

    function G(t, e) {
        var i;
        this.options = K({}, U.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new((i = this).options.inputClass || (ht ? M : ct ? j : at ? A : O))(i, I), this.touchAction = new P(this, this.options.touchAction), Z(this, !0), s(this.options.recognizers, function(t) {
    ...
    function Z(t, e) {
        var i, n = t.element;
        n.style && (s(t.options.cssProps, function(o, r) {
            i = b(n.style, r), e ? (t.oldCssProps[i] = n.style[i], n.style[i] = o) : n.style[i] = t.oldCssProps[i] || ""
        }), e || (t.oldCssProps = {}))
    }
    var K, J = ["", "webkit", "Moz", "MS", "ms", "o"],
        $ = e.createElement("div"),
        tt = "function",
        et = Math.round,
        it = Math.abs,
    ...
    var Tt = {
        ...
        kt = "mousedown",
        St = "mousemove mouseup";
    h(O, L, {
        handler: function(t) {
            var e = Tt[t.type];
            e & pt && 0 === t.button && (this.pressed = !0), e & ft && 1 !== t.which && (e = mt), this.pressed && (e & mt && (this.pressed = !1), this.callback(this.manager, e, {
                pointers: [t],
                changedPointers: [t],
                pointerType: dt,
                srcEvent: t
    ...
    t.MSPointerEvent && !t.PointerEvent && (zt = "MSPointerDown", jt = "MSPointerMove MSPointerUp MSPointerCancel"), h(M, L, {
        handler: function(t) {
            var e = this.store,
                i = !1,
            ...
            o & pt && (0 === t.button || s) ? 0 > a && (e.push(t), a = e.length - 1) : o & (mt | gt) && (i = !0), 0 > a || (e[a] = t, this.callback(this.manager, o, {
                pointers: e,
                changedPointers: [t],
                pointerType: r,
                srcEvent: t
        ...
        handler: function(t) {
            ...
            if (e === pt && (this.started = !0), this.started) {
                var i = function(t, e) {
                    ...
                    return e & (mt | gt) && (i = w(i.concat(n), "identifier", !0)), [i, n]
                }.call(this, t, e);
                e & (mt | gt) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, e, {
                    pointers: i[0],
                    changedPointers: i[1],
                    pointerType: lt,
                    srcEvent: t
        ...
        handler: function(t) {
            var e = Wt[t.type],
                i = function(t, e) {
                    var i = y(t.touches),
                        n = this.targetIds;
                    if (e & (pt | ft) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
                    ...
                    for (o = 0; o < s.length;) n[s[o].identifier] && a.push(s[o]), e & (mt | gt) && delete n[s[o].identifier], o++;
    ...
    h(A, L, {
        handler: function(t, e, i) {
            ...
            if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                if (n)(function(t, e) {
                    t & pt ? (this.primaryTouch = e.changedPointers[0].identifier, R.call(this, e)) : t & (mt | gt) && R.call(this, e)
                }).call(this, e, i);
    ...
    P.prototype = {
        set: function(t) {
            t == Yt && (t = this.compute()), Ht && this.manager.element.style && Gt[t] && (this.manager.element.style[Bt] = t), this.actions = t.toLowerCase().trim()
        },
        update: function() {
        ...
        compute: function() {
            ...
            return s(this.manager.recognizers, function(e) {
                ...
                function(t) {
                    ...
                    var e = m(t, Vt),
                        i = m(t, Ut);
                    return e && i ? Qt : e || i ? e ? Vt : Ut : m(t, Xt) ? Xt : Ft
                }(t.join(" "))
        },
        preventDefaults: function(t) {
            ...
            if (!this.manager.session.prevented) {
                ...
                return s && r ? void 0 : o || r && i & Lt || s && i & It ? this.preventSrc(e) : void 0
            }
            e.preventDefault()
        },
    ...
    W.prototype = {
        ...
        recognizeWith: function(t) {
            ...
            return e[(t = N(t, this)).id] || (e[t.id] = t, t.recognizeWith(this)), this
        },
        dropRecognizeWith: function(t) {
            return r(t, "dropRecognizeWith", this) ? this : (t = N(t, this), delete this.simultaneous[t.id], this)
        },
        requireFailure: function(t) {
            if (r(t, "requireFailure", this)) return this;
            var e = this.requireFail;
            return -1 === v(e, t = N(t, this)) && (e.push(t), t.requireFailure(this)), this
        },
        ...
        emit: function(t) {
            ...
            var i = this,
                n = this.state;
            $t > n && e(i.options.event + D(n)), e(i.options.event), t.additionalEvent && e(t.additionalEvent), n >= $t && e(i.options.event + D(n))
        },
        tryEmit: function(t) {
        ...
        recognize: function(t) {
            var e = K({}, t);
            return l(this.options.enable, [this, e]) ? (this.state & (te | ee | 32) && (this.state = Zt), this.state = this.process(e), void(this.state & (Kt | Jt | $t | ee) && this.tryEmit(e))) : (this.reset(), void(this.state = 32))
        },
        process: function(t) {},
        ...
        process: function(t) {
            var e = this.state,
                ...
                n = e & (Kt | Jt),
                o = this.attrTest(t);
            return n && (i & gt || !o) ? e | ee : n || o ? i & mt ? e | $t : e & Kt ? e | Jt : Kt : 32
        }
    }), h(H, B, {
        defaults: {
            event: "pan",
        ...
        getTouchAction: function() {
            var t = this.options.direction,
                e = [];
            return t & Lt && e.push(Ut), t & It && e.push(Vt), e
        },
        directionTest: function(t) {
            var e = this.options,
                ...
                r = t.deltaX,
                s = t.deltaY;
            return o & e.direction || (e.direction & Lt ? (o = 0 === r ? vt : 0 > r ? yt : wt, i = r != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === s ? vt : 0 > s ? bt : xt, i = s != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
        },
        attrTest: function(t) {
            return B.prototype.attrTest.call(this, t) && (this.state & Kt || !(this.state & Kt) && this.directionTest(t))
        },
        emit: function(t) {
        ...
        process: function(t) {
            ...
            if (this._input = t, !n || !i || t.eventType & (mt | gt) && !r) this.reset();
            else if (t.eventType & pt) this.reset(), this._timer = o(function() {
                this.state = te, this.tryEmit()
            }, e.time, this);
            else if (t.eventType & mt) return te;
            return 32
        },
        reset: function() {
        ...
        emit: function(t) {
            this.state === te && (t && t.eventType & mt ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = nt(), this.manager.emit(this.options.event, this._input)))
        }
    }), h(X, B, {
        defaults: {
            event: "rotate",
        ...
        attrTest: function(t) {
            ...
            return i & (Lt | It) ? e = t.overallVelocity : i & Lt ? e = t.overallVelocityX : i & It && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && it(e) > this.options.velocity && t.eventType & mt
        },
        emit: function(t) {
    ...
    G.prototype = {
        ...
        recognize: function(t) {
            ...
            if (!e.stopped) {
                ...
                for (var r = 0; r < n.length;) i = n[r], 2 === e.stopped || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (Kt | Jt | $t) && (o = e.curRecognizer = i), r++
            }
        },
        get: function(t) {
        ...
        emit: function(t, i) {
            var n, o, r;
            this.options.domEvents && (n = t, o = i, (r = e.createEvent("Event")).initEvent(n, !0, !0), r.gesture = o, o.target.dispatchEvent(r));
            var s = this.handlers[t] && this.handlers[t].slice();
            if (s && s.length) {
                i.type = t, i.preventDefault = function() {
                    i.srcEvent.preventDefault()
                };
                for (var a = 0; a < s.length;) s[a](i), a++
            }
        },
        destroy: function() {
        ...
        bindFn: c,
        prefixed: b
    }), (void 0 !== t ? t : "undefined" != typeof self ? self : {}).Hammer = U, "function" == typeof define && define.amd ? define(function() {
        return U
...
function(t) {
    t.fn.fitVids = function(e) {
        ...
        return e && t.extend(i, e), this.each(function() {
            ...
            var n = ".fitvidsignore";
            i.ignore && (n = n + ", " + i.ignore), (e = (e = (e = t(this).find(e.join(","))).not("object object")).not(n)).each(function() {
                var e = t(this);
                if (!(0 < e.parents(n).length || "embed" === this.tagName.toLowerCase() && e.parent("object").length || e.parent(".fluid-width-video-wrapper").length)) {
                    ...
                    i = i / o;
                    e.attr("id") || (o = "fitvid" + Math.floor(999999 * Math.random()), e.attr("id", o)), e.wrap('<div class="fluid-width-video-wrapper"></div>').parent(".fluid-width-video-wrapper").css("padding-top", 100 * i + "%"), e.removeAttr("height").removeAttr("width")
                }
            })
        })
    }
}(window.jQuery || window.Zepto), jQuery.fn.styledSelect = function(t) {
    var e = {
...
function(t) {
    ...
    function e(e, o) {
        ...
        if (n.raw) r = e;
            ...
            var s = e;0 === s.indexOf('"') && (s = s.slice(1, -1).replace(/\\"/g, '"').replace(/\\\\/g, "\\"));
            try {
                s = decodeURIComponent(s.replace(i, " ")), r = n.json ? JSON.parse(s) : s;
                break t
            } catch (t) {}
            r = void 0
        }
        return t.isFunction(o) ? o(r) : r
    }
    var i = /\+/g,
        n = t.cookie = function(i, o, r) {
            if (void 0 !== o && !t.isFunction(o)) {
                if ("number" == typeof(r = t.extend({}, n.defaults, r)).expires) {
                    var s = r.expires;
                    (h = r.expires = new Date).setDate(h.getDate() + s)
                }
                return document.cookie = [n.raw ? i : encodeURIComponent(i), "=", (a = o, a = n.json ? JSON.stringify(a) : String(a), n.raw ? a : encodeURIComponent(a)), r.expires ? "; expires=" + r.expires.toUTCString() : "", r.path ? "; path=" + r.path : "", r.domain ? "; domain=" + r.domain : "", r.secure ? "; secure" : ""].join("")
            }
            var a;
            r = i ? void 0 : {};
            for (var h = 0, c = (s = document.cookie ? document.cookie.split("; ") : []).length; h < c; h++) {
                var l, d = s[h].split("=");
                if (l = d.shift(), l = n.raw ? l : decodeURIComponent(l), d = d.join("="), i && i === l) {
                    r = e(d, o);
                    break
                }
                i || void 0 === (d = e(d)) || (r[l] = d)
            }
            return r
        };
...
function(t, e, i) {
    ...
    (i = function(t) {
        ...
        _update: function(t) {
            return this._clear(), this.circles.forEach(function(e, i, n) {
                e.update(t)
            }), this
        },
        _clear: function() {
    ...
    var o = function(t) {
        if (this.id = t.id, this.canvas = t.canvas, this.context = t.context, this.centerX = t.centerX, this.centerY = t.centerY, this.arcWidth = t.arcWidth, this.innerRadius = t.innerRadius || 0, this.fillColor = t.fillColor || "#fff", this.outlineColor = t.outlineColor || this.fillColor, this.progressListener = t.progressListener, this.infoLineLength = t.infoLineLength || 250, this.horizLineLength = t.horizLineLength || 50, this.infoListener = t.infoListener, this.infoLineAngle = t.infoLineAngle, this.outerRadius = this.innerRadius + this.arcWidth, this.infoListener) {
            var i = this.infoLineAngle;
            t = (this.innerRadius + this.outerRadius) / 2;
            var o = Math.sin(i);
            i = Math.cos(i);
            this.infoLineStartX = this.centerX + o * t, this.infoLineStartY = this.centerY - i * t, this.infoLineMidX = this.centerX + o * this.infoLineLength, this.infoLineMidY = this.centerY - i * this.infoLineLength, this.infoLineEndX = this.infoLineMidX + (0 > o ? -this.horizLineLength : this.horizLineLength), this.infoLineEndY = this.infoLineMidY, (o = (t = e.createElement("div")).style).color = this.fillColor, o.position = "absolute", o.left = this.infoLineEndX + n(this.canvas)[0] + "px", t.className = "ProgressCircleInfo", t.id = "progress_circle_info_" + this.id, e.body.appendChild(t), this.infoText = t
        }
    };
    o.prototype = {
        constructor: o,
        update: function(t) {
            this.progress = t || this.progressListener(), this._draw(), this.infoListener && (this.info = this.infoListener(), this._drawInfo())
        },
        _draw: function() {
            var t = this.context,
                e = 0 + -Math.PI / 2,
                ...
                r = this.innerRadius,
                s = this.outerRadius;
            return t.fillStyle = this.fillColor, t.strokeStyle = this.outlineColor, t.beginPath(), t.arc(n, o, r, e, i, !1), t.arc(n, o, s, i, e, !0), t.closePath(), t.stroke(), t.fill(), this
        },
        _drawInfo: function() {
            var t;
            ...
            ], !1), this.infoText.innerHTML = this.info, t = this.infoText.offsetHeight, this.infoText.style.top = this.infoLineEndY + n(this.canvas)[1] - t / 2 + "px", this
        },
        _drawSegments: function(t, e) {
            var i = this.context;
            i.beginPath(), i.moveTo(t[0][0], t[0][1]);
            for (var n = 1; n < t.length; ++n) i.lineTo(t[n][0], t[n][1]);
            e && i.closePath(), i.stroke()
        }
    }, t.ProgressCircle = i
...
function(t) {
    t.fn.styledSelect = function() {
        return this.each(function() {
            var e = t(this),
                i = t(this).children("option").length;
            e.addClass("s-hidden"), e.wrap('<div class="styledSelect' + (e.attr("data-class") ? " " + e.attr("data-class") : "") + '"></div>'), e.after('<div class="select"></div>');
            var n = e.next("div.select"),
                o = e.children("option:selected"),
                r = (o.attr("data-photo") ? '<img src="' + o.attr("data-photo") + '" />' : "") + (o.attr("data-icon") ? '<span class="ir ico ' + o.attr("data-icon") + '"></span>' : "") + o.text();
            n.html(r);
            for (var s = t("<ul />", {
                    class: "options"
                }).insertAfter(n), a = 0; a < i; a++) {
                var h = (e.children("option").eq(a).attr("data-photo") ? '<img src="' + e.children("option").eq(a).attr("data-photo") + '" />' : "") + (e.children("option").eq(a).attr("data-icon") ? '<span class="ir ico ' + e.children("option").eq(a).attr("data-icon") + '"></span>' : "") + e.children("option").eq(a).text(),
                    c = e.children("option").eq(a);
                t("<li />", {
                    html: h,
                    rel: e.children("option").eq(a).val(),
                    class: (o.val() == c.val() ? "active" : "") + (c.attr("disabled") ? " disabled" : ""),
                    "data-photo": c.attr("data-photo"),
                    "data-icon": c.attr("data-icon")
                }).appendTo(s)
            }
            var l = s.children("li");
            e.attr("data-error") && e.parent().append('<div class="select__error">' + e.attr("data-error") + '</div><div class="select__ico select__ico--error"></div></div><div class="select__ico select__ico--ok"></div>'), n.click(function(e) {
                e.stopPropagation(), t(this).hasClass("active") || t("div.select.active").each(function() {
                    t(this).removeClass("active").next("ul.options").hide()
                }), t(this).toggleClass("active").next("ul.options").toggle()
            }), l.click(function(i) {
                i.stopPropagation();
                var o = t(this);
                if (!o.hasClass("disabled")) {
                    var r = (o.attr("data-photo") ? '<img src="' + o.attr("data-photo") + '" />' : "") + (o.attr("data-icon") ? '<span class="ir ico ' + o.attr("data-icon") + '"></span>' : "") + o.text();
                    n.html(r).removeClass("active"), e.val() != t(this).attr("rel") && e.val(t(this).attr("rel")).change(), s.hide()
                }
...
function(t, e) {
    ...
    function n(t, e, o) {
        ...
        var r, c = t;
        return "string" == typeof t && (c = document.querySelectorAll(t)), c ? (this.elements = (r = c, Array.isArray(r) ? r : "object" == typeof r && "number" == typeof r.length ? h.call(r) : [r]), this.options = i({}, this.options), "function" == typeof e ? o = e : i(this.options, e), o && this.on("always", o), this.getImages(), s && (this.jqDeferred = new s.Deferred), void setTimeout(this.check.bind(this))) : void a.error("Bad element for imagesLoaded " + (c || t))
    }
...
function(t, e, i) {
    var n = function(t) {
        ...
        o = function(t) {
            this.canvas = t.canvas, this.minRadius = t.minRadius || 15, this.arcWidth = t.arcWidth || 5, this.gapWidth = t.gapWidth || 3, this.centerX = t.centerX || this.canvas.width / 2, this.centerY = t.centerY || this.canvas.height / 2, this.infoLineLength = t.infoLineLength || 60, this.horizLineLength = t.horizLineLength || 10, this.infoLineAngleInterval = t.infoLineAngleInterval || Math.PI / 8, this.infoLineBaseAngle = t.infoLineBaseAngle || Math.PI / 6, this.context = this.canvas&&this.canvas.getContext("2d")||{}, this.width = this.canvas&&this.canvas.width||0, this.height = this.canvas&&this.canvas.height||0, this.circles = [], this.runningCount = 0
        };
    o.prototype = {
        constructor: o,
        addEntry: function(t) {
            return this.circles.push(new r({
                canvas: this.canvas,
                context: this.context,
                centerX: this.centerX,
                centerY: this.centerY,
        ...
        _update: function() {
            return this._clear(), this.circles.forEach(function(t, e, i) {
                t.update()
            }), this
        },
        _clear: function() {
            return this.context&&this.context.clearRect&&this.context.clearRect(0, 0, this.canvas&&this.canvas.width||0, this.canvas&&this.canvas.height||0), this
        }
    };
    var r = function(t) {
        if (this.id = t.id, this.canvas = t.canvas, this.context = t.context, this.centerX = t.centerX, this.centerY = t.centerY, this.arcWidth = t.arcWidth, this.innerRadius = t.innerRadius || 0, this.fillColor = t.fillColor || "#fff", this.outlineColor = t.outlineColor || this.fillColor, this.progressListener = t.progressListener, this.infoLineLength = t.infoLineLength || 250, this.horizLineLength = t.horizLineLength || 50, this.infoListener = t.infoListener, this.infoLineAngle = t.infoLineAngle, this.outerRadius = this.innerRadius + this.arcWidth, this.infoListener) {
            var i = this.infoLineAngle,
                o = (this.innerRadius + this.outerRadius) / 2,
                r = Math.sin(i),
                s = Math.cos(i);
            this.infoLineStartX = this.centerX + r * o, this.infoLineStartY = this.centerY - s * o, this.infoLineMidX = this.centerX + r * this.infoLineLength, this.infoLineMidY = this.centerY - s * this.infoLineLength, this.infoLineEndX = this.infoLineMidX + (r < 0 ? -this.horizLineLength : this.horizLineLength), this.infoLineEndY = this.infoLineMidY;
            var a = e.createElement("div"),
                h = a.style;
            h.color = this.fillColor, h.position = "absolute", h.left = this.infoLineEndX + n(this.canvas)[0] + "px", a.className = "ProgressCircleInfo", a.id = "progress_circle_info_" + this.id, e.body.appendChild(a), this.infoText = a
        }
    };
    r.prototype = {
        constructor: r,
        ...
        _draw: function() {
            var t = this.context,
                ...
                r = this.innerRadius,
                s = this.outerRadius;
            return t.fillStyle = this.fillColor, t.strokeStyle = this.outlineColor, t.beginPath&&t.beginPath(), t.arc&&t.arc(n, o, r, e, i, !1), t.arc&&t.arc(n, o, s, i, e, !0), t.closePath&&t.closePath(), t.stroke&&t.stroke(), t.fill&&t.fill(), this
        },
        _drawInfo: function() {
            var t, e;
            return t = [
                ...
                [this.infoLineMidX, this.infoLineMidY],
                [this.infoLineEndX, this.infoLineEndY]
            ], this._drawSegments(t, !1), this.infoText.innerHTML = this.info, e = this.infoText.offsetHeight, this.infoText.style.top = this.infoLineEndY + n(this.canvas)[1] - e / 2 + "px", this
        },
        _drawSegments: function(t, e) {
            var i = this.context;
            i.beginPath(), i.moveTo(t[0][0], t[0][1]);
...
$(function() {
/**
, subscriptions, , define digital rights, and access API for one purpose:<span class="awesomeness">&nbsp;</span>
 */
$(".heading-hero_H").typed({
    strings: ["Build Teams", "Raise Funds", "Manage Productions", "Define Digital Rights", 'One Purpose','<span class="awesomeness fw700">Make Stories Happen</span>'],
    typeSpeed: 13,
    backSpeed: 5,
    backDelay: 610,
    showCursor: false,
