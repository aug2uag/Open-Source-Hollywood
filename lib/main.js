...
Meteor.methods({
    ...
    addProject: function (options, cb) {
        ...
        if (previousProjectExists) {
          validOptions = false
          future.throw(new Meteor.Error("Error: duplicate project", "This campaign contains a title identical to a previous project of yours. Please update the campaign to a new title so it is unique."))
        }
