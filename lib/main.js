...
Meteor.methods({
  ...
  resendVerification: function(reverify) {
    ...
    if (reverify==='email') {
      ...
      var verificationURL = 'https://app.opensourcehollywood.org/verify/' + guid2 + '/' + guid1;
  ...
  pokeApplicant: function(options) {
    ...
    var miniURL = getMiniURL(fullURL);
    var msg = (options.audition&&options.audition!=='N/A') ? 'You\'ve been selected to submit audition information, please upload your audition' : 'You have been selected to negotiate your offer';
    ProjectMessages.insert({
      project: options.project,
      slug: options.slug,
      title: project.title,
    ...
    notifyByEmailAndPhone({
      user: options.uid,
      title: 'Congratulations, you have been selected to discuss your offer.',
