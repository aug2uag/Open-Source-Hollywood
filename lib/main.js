...
Meteor.methods({
    ...
    lendResource: function(options) {
      ...
      if (Meteor.isServer) {
        ...
        if (Meteor.user().notification_preferences&&Meteor.user().notification_preferences.email&&Meteor.user().notification_preferences.email.verification) {
          options.user.email = Meteor.user().notification_preferences.email.email
        };
    ...
    */
    ...
    offerProjectAsset: function(options) {
      ...
      if (Meteor.user().notification_preferences&&Meteor.user().notification_preferences.email&&Meteor.user().notification_preferences.email.verification) {
        o.offer.user.email = Meteor.user().notification_preferences.email.email
      };
    ...
    acceptAssetsOffer: function(options) {
      ...
      createReceipt({
        ...
        email: me.notification_preferences&&me.notification_preferences.email&&me.notification_preferences.email.email||null,
