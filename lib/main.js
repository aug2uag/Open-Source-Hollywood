...
function sendEmailNotification(email, html, text, subject) {
  var params = {
    Destination: {
     ToAddresses: [
        email
...
Meteor.methods({
  ...
  resendVerification: function(reverify) {
    ...
    if (reverify==='email') {
      ...
      var _html = "Your email was provided as a source for notifications on Open Source Hollywood. To verify, please visit the following link: <a class=\"ulink\" href=\"" + verificationURL + "\" target=\"_blank\">Click Here to Verify Email</a>.";
