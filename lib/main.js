...
Meteor.methods({
    ...
    */
    ...
    revokeOffer: function(options) {
      ...
      try {
        options.forEach(function(o) {
          ...
          if (o.receipt) {
            ...
            // return declinedUserRefund(o.receipt.id, project, o.receipt.amount, receipts, function() {  })
        ...
        // else, set revoke flag
        // offer should be invalid
        console.log('in revokeOffer')
      ...
      console.log('finished revokeOffer')
      console.log(receipts)
