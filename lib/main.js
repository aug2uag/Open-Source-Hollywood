...
Meteor.methods({
  ...
  addProject: function (options) {
    ...
    if (Meteor.isClient) {
      vex.dialog.alert("Project created! Check your Dashboard for information about applicants, and to share your project with the world.");
      Router.go('Projects');
    } 
  },
  ...
  closeProject: function(slug) {
    ...
    if (Meteor.isClient) {
      vex.dialog.confirm('This campaign is history.', function() {
        Router.go('Home');
      });
    };
  },
